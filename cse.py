...
OpenUrl='https://cse.knu.ac.kr/06_sub/02_sub.html'
driver.get(OpenUrl)
driver.implicitly_wait(10)

for i in range (1, 71):
    Xpath="//*[@id=\"content\"]/article/article[3]/div[1]/table/tbody/tr[" +  str(i)  + "]/td[1]"
